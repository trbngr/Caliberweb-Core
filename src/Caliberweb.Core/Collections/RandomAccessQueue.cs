...
namespace Caliberweb.Core.Collections
{
    ...
    /// </summary>
    public sealed class RandomAccessQueue<T> : ICollection<T>, ICollection, ICloneable where T : class
    {
        /// <summary>
        ...
        {
            buffer = new T[Math.Max(capacity, DEFAULT_CAPACITY)];
        }
        ...
        /// </summary>
        public RandomAccessQueue() : this(DEFAULT_CAPACITY)
        {}
...
// ReSharper restore PossibleNullReferenceException
        ...
        {
            int newCapacity = Math.Max(Count, DEFAULT_CAPACITY);
