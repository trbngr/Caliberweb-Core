...
using Caliberweb.Core.Collections;
...
namespace Caliberweb.Core.Threading
{
    ...
    public class CustomThreadPool
    {
        ...
        /// The queue itself.
        /// </summary>
        private readonly RandomAccessQueue<ThreadPoolWorkItem> queue = new RandomAccessQueue<ThreadPoolWorkItem>();
        ...
        private int idlePeriod = DEFAULT_IDLE_PERIOD;
        ...
        #region Nested type: PriorityComparer
        ...
        private class PriorityComparer : IComparer<ThreadPoolWorkItem>
        {
            ...
            #region IComparer<ThreadPoolWorkItem> Members
